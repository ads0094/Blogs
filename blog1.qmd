...
You know or hypothesize a population mean ($\mu$)

You compare your sample mean to this known/hypothesized population mean
```

-   Two-sample z-test:

```         
You know the population standard deviations for both populations

You don't necessarily need to know the population means

You're testing if there's a significant difference between the two population means
```
...
You don't need to know means or standard deviations

You use the properties of the binomial distribution
```
